...
train_dataloader = DataLoader(split_datasets['train'], shuffle=True, batch_size=4) #, collate_fn=data_collator)
eval_dataloader = DataLoader(split_datasets['test'], batch_size=4) #, collate_fn=data_collator)
